...
public class SignUpSUCCTest {
    ...
    @Test
    public void testSignUpSUCC() throws Exception {
        ...
        driver.findElement(By.xpath("//div[@id='operations-authentication-controller-signup']/div[2]/div/div[3]/div[2]/div/div/table/tbody/tr/td")).click();
        try {
            assertEquals("200", driver.findElement(By.xpath("//div[@id='operations-authentication-controller-signup']/div[2]/div/div[3]/div[2]/div/div/table/tbody/tr/td")).getText());
        } catch (Error e) {
